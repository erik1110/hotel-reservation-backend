import { Controller, Post, Body, HttpStatus, UsePipes, ValidationPipe, HttpException } from '@nestjs/common';
...
export class UsersController {
  ...
  async signup(@Body() createUserDto: CreateUserDto) {
    ...
    if (checkEmail) {
      throw new AppError(HttpStatus.BAD_REQUEST, 'Data', 'Duplicated Email');
    }
